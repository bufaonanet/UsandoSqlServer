...
SELECT BAIRRO, ESTADO, SUM([LIMITE DE CREDITO]) limite_estado FROM [TABELA DE CLIENTES] 
WHERE [ESTADO]  = 'SP' GROUP BY BAIRRO, ESTADO having SUM([LIMITE DE CREDITO]) > 70000.00
